function graph_raw(x_vec, y_vec, BETA, step, ind_spec, varargin)
    ...
    edge_ind = find(ind_spec == leap_ind, 1); 
    y_vec(leap_ind) = NaN;  
    ...
    scatter(my_ax, x_vec(ind_spec(1:edge_ind)), y_vec(ind_spec(1:edge_ind)) , 12, 'o', 'filled', 'MarkerFaceColor', blackcolor);
